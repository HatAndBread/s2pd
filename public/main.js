...
import { s2pd } from './shapes.js';
console.log(s2pd);

s2pd.createCanvas('canvas', 800, 600);
s2pd.backgroundColor(50, 243, 156, 0.2);

const dog = new s2pd.Circle(200, 200, 200, s2pd.getRandomColor(), 30);
console.log(dog);
/*const app = s2pd();
...
const dog = new app.Circle(40, 40, 30, 'rgb(100,40,240)', 5);
